...
class UserPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // async fetch inside FutureBuilder
    final futureUsername = ref
        .read(gameListControllerProvider(user.id).notifier)
        .getUsername(user.id);
                ...
                Card(
                  ...
                  child: Column(
                    children: [
                      ...
                      _userEntry('Name', username),
                      _userEntry('Email', user.email),
                      _userEntry(
                        'Updated At',
                        user.lastUpdated.toIso8601String(),
                      ),
                    ],
                  ),
                ),
